...
const associationAims = [
  ...
  <span>
    To help and assist the Management of MES
    <span style={{ verticalAlign: "super" }}>&#174;</span> in the growth and
    development of the college by way of contributions collected from the
    members of the Association
  </span>,
  "To promote the cause of education in all spheres and the interests of the college, in all possible ways",
  "To sponsor and help with the education of students who are socially and economically challenged by providing scholarships, enabled services, etc",
  ...
  <span>
    To establish, maintain and run benevolent funds to help the needy
    educational fraternity consisting of students, teachers, evaluators,
    administrators and all connected with the field of education by providing
    financial, medical and other assistance with special preference to MES
    <span style={{ verticalAlign: "super" }}>&#174;</span> students
  </span>,
