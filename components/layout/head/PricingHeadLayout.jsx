...
const PricingHeadLayout = (props) => {
  return (
    <Fragment>
      <CommonHeadLayout />
      <Head>
        <title>The MES College Alumni Association&reg; | Pricing</title>
        <meta
          name="description"
          content="Choose between a lifetime or an annual membership and register yourself."
        />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="The MES Alumni Association | Pricing"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://mesalumniassociation.com/pricing"
        />
...
export default PricingHeadLayout;
